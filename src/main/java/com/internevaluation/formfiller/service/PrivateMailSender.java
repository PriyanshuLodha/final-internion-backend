...
//            privateMailService.send(listOfUser.getListUser().get(i),buildEmail(listOfUser.getUsername(),listOfUser.getListUser().get(i)));
    ...
    public String buildEmail(String senderName, String receiverName) {
        return "Sent from "+senderName+" password is his username.";
    }
    ...
    public void sendEmailWithAttachment(String to, String text,String sender,String filename){
        try {
            ...
            byte[] pdfBytes = Files.readAllBytes(Paths.get("C:\\Users\\Priyanshu\\OneDrive\\Desktop\\Training\\internion\\form-backend\\src\\main\\java\\com\\internevaluation\\formfiller\\datafolder\\"+sender+"\\"+filename));
    ...
    public void sendEmailWithAttachmentToSingleUser(String to, String text,String sender,String filename){
        try {
            ...
            byte[] pdfBytes = Files.readAllBytes(Paths.get("C:\\Users\\Priyanshu\\OneDrive\\Desktop\\Training\\internion\\form-backend\\src\\main\\java\\com\\internevaluation\\formfiller\\datafolder\\"+sender+"\\"+filename+".pdf"));
            Resource pdfAttachment = new ByteArrayResource(pdfBytes);
            helper.addAttachment("document.pdf", pdfAttachment);
